...
/**
 * TEMPORARY PLACEHOLDER — required so the "profile" tab declared in
 * app/(tabs)/_layout.tsx resolves to a real route (Expo Router crashes
 * otherwise). This is NOT the real profile screen; replace in a later phase.
 */
  ...
  return (
    <View style={styles.root}>
      ...
      <SafeAreaView style={styles.safe}>
        <User size={40} color="#6D5BD0" strokeWidth={1.6} />
